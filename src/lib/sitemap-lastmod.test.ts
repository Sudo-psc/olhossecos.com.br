...
test("o lastmod das páginas-pilar acompanha a revisão declarada na página", () => {
  ...
  assert.equal(lastmodForPath("/profissional"), "2026-09-15");
  assert.equal(lastmodForPath("/superficie"), "2026-09-15");
  assert.equal(lastmodForPath("/superficie/radar"), "2026-09-15");
  assert.equal(lastmodForPath("/superficie/edicao-00"), "2026-08-07");
  assert.equal(lastmodForPath("/ferramentas"), "2026-08-25");
  assert.equal(lastmodForPath("/paciente"), "2026-09-14");
